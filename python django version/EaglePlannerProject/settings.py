"""
Django settings for EaglePlannerProject project.
...
SECRET_KEY = 'django-insecure-11bk+$n4=rr5bl&bz1du$6(!!8#tmw8-a$k$+llkqs&h6j)z44'
...
ROOT_URLCONF = 'EaglePlannerProject.urls'
...
WSGI_APPLICATION = 'EaglePlannerProject.wsgi.application'
ASGI_APPLICATION = 'EaglePlannerProject.routing.application'
